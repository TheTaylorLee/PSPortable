...
CmdletsToExport = @('Connect-HCXServer','Disconnect-HCXServer','Get-HCXAppliance','Get-HCXComputeProfile','Get-HCXContainer','Get-HCXDatastore','Get-HCXGateway','Get-HCXInterconnectStatus','Get-HCXInventoryCompute','Get-HCXInventoryDatastore','Get-HCXInventoryDVS','Get-HCXInventoryNetwork','Get-HCXJob','Get-HCXMigration','Get-HCXNetwork','Get-HCXNetworkBacking','Get-HCXNetworkExtension','Get-HCXNetworkProfile','Get-HCXReplication','Get-HCXReplicationSnapshot','Get-HCXService','Get-HCXServiceMesh','Get-HCXSite','Get-HCXSitePairing','Get-HCXStorageProfile','Get-HCXVM','New-HCXAppliance','New-HCXComputeProfile','New-HCXComputeProfileDVS','New-HCXComputeProfileNetwork','New-HCXMigration','New-HCXNetworkExtension','New-HCXNetworkMapping','New-HCXNetworkProfile','New-HCXReplication','New-HCXSentinelBundle','New-HCXServiceMesh','New-HCXServiceMeshDVS','New-HCXSitePairing','New-HCXStaticRoute','Remove-HCXAppliance','Remove-HCXComputeProfile','Remove-HCXNetworkExtension','Remove-HCXNetworkProfile','Remove-HCXReplication','Remove-HCXServiceMesh','Remove-HCXSitePairing','Resume-HCXReplication','Set-HCXAppliance','Set-HCXComputeProfile','Set-HCXMigration','Set-HCXNetworkProfile','Set-HCXReplication','Set-HCXServiceMesh','Start-HCXMigration','Start-HCXReplication','Suspend-HCXReplication','Test-HCXMigration','Test-HCXReplication','Wait-HCXJob')
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCkfVzAwoAtoD2LwiEQBT492c
# 9WOgghhkMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# ARUwIwYJKoZIhvcNAQkEMRYEFOKGYovucZwETvmrTb545Jzd0h/FMCoGCisGAQQB
# gjcCAQwxHDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wDQYJKoZIhvcNAQEB
# BQAEggEAl4ew748S4IXiKccLhXxexq/1R3nZ+YwysuHLjNXL2FkIJ6HvH5+sssYB
# 9VxCoJNeoiFzY4Lma4qJSG3RZwYF8YPL/UiY4awddlnQOXPY8DikYKOdUzuHnsF0
# 2YFVpVl+17R9H5UjyyZdtR31ie+AGp2Zlw3Kkq9jjZVpHhNhR6Clrdo4gwmhqm5N
# NhohSH7hP7yBRQgaA+tJQ6v5lB6eOgO91+q5two0Cq81e2s6nioHGF/R5lo6uZlJ
# tX0AiaSLW2RPAqXoiQl09J9paa0QovW0qIvPqfOVhgRwfrT+J85lQDfJ2kYxL53V
# rVmZ2IoDtaCIVyZmFGthsH57n9F9CqGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB
...
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xOTEwMTgyMTUxNDVaMCMG
# CSqGSIb3DQEJBDEWBBQS3GMz9yZ0u0pDzihDw4qrggXV8DANBgkqhkiG9w0BAQEF
# AASCAQBVktpjOu794kSYaiXl4WgHB0BRNgPjbpRJpoP2Xj0YSuIXZNMeX8oqpPpi
# zMfsHoVGRrwYbFPlJA2Z3CF3Maf92mgsGMiBwAT4ASCJhfbneOOQF8HNFsDdmwap
# JKZCxXAGDs3bMbUDvt8DH5d9qG5T7RQYWE4oN03kTyZaIZkHTvjCpUWt154IaanM
# GlYLVz75RZ7byuliJUuMO3VnLNE1C7foPsvepSbUmfdnBAcC73y0OqKYu9C+GJKa
# v4Foe6fdxnEasN9Hn3dYIhCDPbyzhnD3XCXhA8t8ll83lPSLLBUfWVLuIM6eLvSu
# WSHj2EvPrGewGUAhrWvIXOWFcZ6v
