...
" -ForegroundColor Green
    ...
    Write-Host "Use Show-Docs to get online help and Examples                       "                   -ForegroundColor Cyan   -NoNewline
    Write-Host "<"                                                                                      -ForegroundColor Green
    Write-Host "             > "                                                                        -ForegroundColor Green  -NoNewline
    ...
    Write-Host "<"                                                                                      -ForegroundColor Green
    Write-Host "             > "                                                                        -ForegroundColor Green  -NoNewline
    Write-Host "Do not input spaces in your parameter values!  "                                        -ForegroundColor Yellow -NoNewline
    Write-Host "                     <"                                                                 -ForegroundColor Green
    Write-Host "             > "                                                                        -ForegroundColor Green  -NoNewline
