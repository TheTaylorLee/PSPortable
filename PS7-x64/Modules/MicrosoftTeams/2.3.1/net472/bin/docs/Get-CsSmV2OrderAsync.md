...
online version: https://docs.microsoft.com/en-us/powershell/module/Teams/get-cssmv2orderasync
schema: 2.0.0
---

# Get-CsSmV2OrderAsync
...
### Get (Default)
```
Get-CsSmV2OrderAsync -OrderId <String> -TenantId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CsSmV2OrderAsync -InputObject <IConfigApiBasedCmdletsIdentity> [<CommonParameters>]
```
