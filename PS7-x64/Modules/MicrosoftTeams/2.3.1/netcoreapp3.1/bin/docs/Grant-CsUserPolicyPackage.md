...
online version: https://docs.microsoft.com/en-us/powershell/module/Teams/grant-csuserpolicypackage
schema: 2.0.0
---
...
```
Grant-CsUserPolicyPackage -Identity <String[]> -PackageName <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```
