...
online version: https://docs.microsoft.com/en-us/powershell/module/Teams/get-csorderv2async
schema: 2.0.0
---
...
### Get (Default)
```
Get-CsOrderV2Async -TenantId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-CsOrderV2Async -InputObject <IConfigApiBasedCmdletsIdentity> [<CommonParameters>]
```
